...
If you make changes and want to update the gh-pages site then below is a really hacky way of doing it
...
There is a better way of doing this using Travis. I may update the notes to add some instructions.
